...
// List of major Iranian banks (partial list for validation)
    ...
    {
        "Melli", "Sepah", "Saderat", "Mellat", "Tejarat", "Refah", "Maskan", "Keshavarzi", "Postbank", "Saman",
        "Parsian", "Eghtesad Novin"
    };
    ...
    public CreateBankCommandValidator()
    {
        ...
        RuleFor(x => x.Owner)
            ...
            .Matches(@"^[\p{L}\s]+$")
            .WithMessage("Owner name can only contain letters and spaces"); // Supports Persian characters
